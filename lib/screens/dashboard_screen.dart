    ...
    return Scaffold(
      ...
      body: Consumer<DarziProvider>(
        builder: (context, provider, _) {
          final urgent = provider.urgentOrders;
          final customers = provider.customers;
          final allOrders = provider.allOrders;
          final udhaarOrders = provider.udhaarOrders;

          final pendingCount = allOrders.where((o) => o.isPending).length;
          final totalDues = udhaarOrders.fold<double>(
            0,
            (sum, o) => sum + o.remainingBalance,
          );
          final upcoming = allOrders.where((o) => o.isPending).take(5).toList();
                        ...
                        child: Row(
                          children: [
                            ...
                            _StatCard(
                              ...
                              label: 'Udhaar',
                              value: totalDues > 0
                                  ? 'Rs ${(totalDues / 1000).toStringAsFixed(1)}k'
                                  : 'Rs 0',
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 4),
                                  Text(
                                    'Collected: Rs ${monthCollected.toStringAsFixed(0)}',
                                    style: const TextStyle(
                                      color: Colors.white,
                                      fontSize: 13,
